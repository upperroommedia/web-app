...
export const mapFirebaseResponseToTenant = async (result: IdTokenResult, user: FirebaseUser): Promise<Tenant> => {
...
export const loginWithProvider = async (
  ...
  if (user?.isAnonymous) {
    try {
      ...
      const { linkWithPopup, browserPopupRedirectResolver, updateProfile } = await import('firebase/auth');
