...
} from '@upperroom/shared/shared/bundleConfigs';
...
const holyWeekListOnWrite = createBundleDocumentListener(HOLY_WEEK_BUNDLE_CONFIG);

export { bibleChapterListOnWrite, sundayHomilyListOnWrite, holyWeekListOnWrite };
